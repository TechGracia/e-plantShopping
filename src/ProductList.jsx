...
import { addItem } from './CartSlice'; // Ensure to import addItem from CartSlice
        ...
        <div>
            ...
            <div className="tag">
               ...
               <a href="/" style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>Verdantia Gardens</h3>
                    <i style={{color:'white'}}>Growing Life, One Leaf at a Time</i>
                    </div>
                    </a>
                </div>
            ...
            {/* Display plant grid or cart based on showCart and showPlants */}
            {!showCart ? (
